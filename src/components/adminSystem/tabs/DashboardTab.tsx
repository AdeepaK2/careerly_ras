  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg">
        ...
        <p className="text-blue-100">Monitor and manage your Careerly platform efficiently</p>
      </div>
            ...
            {stats.recentActivities.map((activity) => (
              <div key={activity.id} className="flex items-start space-x-3">
                <div className={`w-2 h-2 rounded-full mt-2 ${
                  ...
                  activity.type === 'company_verification' ? 'bg-green-500' :
                  activity.type === 'job_posting' ? 'bg-purple-500' :
                  'bg-orange-500'
                }`}></div>
          ...
          <div className="grid grid-cols-1 gap-3">
            <button className="flex items-center justify-between p-3 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-gray-900">Review Pending Verifications</span>
              </div>
              <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded-full">{stats.pendingVerifications}</span>
            </button>
