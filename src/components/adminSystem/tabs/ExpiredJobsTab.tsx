...
export default function ExpiredJobsTab() {
  ...
  const fetchExpiredJobs = async () => {
    try {
      ...
      const response = await fetch("/api/admin/job/expired", {
        headers: {
      ...
      if (response.ok) {
        ...
        setMessage("Failed to fetch expired jobs");
        setMessageType("error");
      }
    } catch (error) {
      console.error("Error fetching expired jobs:", error);
      setMessage("Error fetching expired jobs");
      setMessageType("error");
    } finally {
      setLoading(false);
    }
  ...
  const getDaysExpired = (deadline: string) => {
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Expired Jobs</h2>
              <p className="text-gray-600 mt-1">
                Job postings that have passed their application deadline
              </p>
            </div>
        ...
        {jobs.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              There are currently no expired job postings.
            </p>
          </div>
        ) : (
                  ...
                  <tr key={job._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-red-600">
                        {getDaysExpired(job.deadline)} days ago
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-600">
                        Deadline was {formatDate(selectedJob.deadline)}(
                        {getDaysExpired(selectedJob.deadline)} days ago)
                      </p>
                    </div>
                  </div>
                </div>
