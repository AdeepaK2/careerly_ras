...
export default function UndergradLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await login(formData.universityEmail, formData.password);
          ...
          <div className="p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8">
                Welcome back! Sign in to access your career dashboard
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/auth/undergrad/forgot-password" className="text-purple-600 hover:text-purple-800 font-medium">
                    Forgot password?
                  </Link>
                </div>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-purple-600 text-white py-3 px-4 rounded-lg hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200 font-semibold"
                >
                  {loading ? (
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/auth/undergrad/register" className="text-purple-600 hover:text-purple-800 font-semibold">
                    Create Account
                  </Link>
                </p>
              </div>
